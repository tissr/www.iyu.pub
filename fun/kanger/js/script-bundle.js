...
!function a(b, c, d) {
    ...
    1: [function (a, b) {
        b.exports = function (a, b) {
            ...
            return !Modernizr.cssanimations || c ? ($(".scroll-in-animation").removeClass("scroll-in-animation"), void $(".scroll-animation").removeClass("scroll-animation")) : void a.find(".scroll-in-animation, .scroll-animation").each(function () {
                var a = $(this), c = a.data("delay"), d = a.data("animation") + " animated css-animation-show", e = function () {
    ...
    3: [function (a, b) {
        b.exports = function (b) {
            "use strict";
            var c = this, d = (a("../tools/tools.js"), a("../app/scroll-animation.js")), e = $(window), f = ($("html").hasClass("poor-browser"), new d(c, b));
            this.windowTopPos = void 0, this.windowBottomPos = void 0, this.windowH = void 0, this.scroll = function (a) {
                ...
                var b = a.height(), d = a.data("position"), e = d + b;
                return {top: d, bottom: e, height: b, visible: d < c.windowBottomPos && e > c.windowTopPos}
            }
        }
    ...
    4: [function (a, b) {
        b.exports = function () {
            "use strict";
            var b = (a("../app/app-share.js"), $("html").hasClass("poor-browser")), c = 4e3, d = 12e3, e = {scale: 1}, f = {scale: 1.1}, g = [[e, f], [f, e]], h = [{
                or: "left top",
                xr: 0,
                yr: 0
            }, {or: "left center", xr: 0, yr: 1}, {or: "right top", xr: 2, yr: 0}, {
                or: "right center",
                xr: 2,
                yr: 1
            }], i = g.length - 1, j = h.length - 1, k = TWEEN.Easing.Quartic.InOut, l = TWEEN.Easing.Linear.None;
            this.run = function (a) {
                function e(b, m) {
                    var n = a.get(b), o = $(n), p = o.data(), q = Math.round(Math.random() * i), r = Math.round(Math.random() * j), s = g[q];
                    p.ssScale = s[0].scale, p.ssOrig = h[r], p.ssOpacity = b !== f || m ? 1 : 0, b !== f || m || new TWEEN.Tween(p).to({ssOpacity: 1}, c).easing(k).onComplete(function () {
                        a.each(function () {
                            $(this).data().ssOpacity = 1
                        })
                    }).start(), new TWEEN.Tween(p).to({ssScale: s[1].scale}, d).easing(l).start(), b > 0 ? new TWEEN.Tween({ssOpacity: 1}).to({ssOpacity: 0}, c).onUpdate(function () {
    ...
    5: [function (a, b) {
        b.exports = new function () {
            var a = -1 != navigator.appVersion.indexOf("Windows NT 6.1") || -1 != navigator.appVersion.indexOf("Windows NT 6.0") || -1 != navigator.appVersion.indexOf("Windows NT 5.1") || -1 != navigator.appVersion.indexOf("Windows NT 5.0"), b = $("html").hasClass("ie9"), c = $("html").hasClass("ie10"), d = $("html").hasClass("ie11"), e = $("html").hasClass("poor-browser"), f = function () {
                return b || c || d && a ? 0 : d ? -.15 : e ? 0 : -.25
            }();
            this.force3D = !0, this.parallaxMargin = function (a, b, c) {
    ...
    6: [function (a, b) {
        b.exports = new function () {
            ...
            var c, d = a("./app-share.js"), e = a("./themes.js"), f = a("../animation/slide-show.js"), g = new f, h = $("html").hasClass("poor-browser"), i = $("html").hasClass("mobile"), j = 60, k = $("#top-nav"), l = $("#top-nav"), m = l.data("state1-colors"), n = l.data("state2-colors"), o = $("body"), p = $(".view");
            this.prepare = function (a) {
                ...
                if (i) {
                    var e = $("body>img.bg"), f = e.length > 0 ? e : $(".view>img.bg");
                    if (f.length > 0) {
                        var g = $(f[0]);
                        $(".view").each(function () {
                            var a = $(this), b = a.children("img.bg");
                ...
                $(".view.section-header").each(function () {
                    var a = $(this), b = a.nextAll(".view").first().children(".content");
                    b.length > 0 && c(b) && a.children(".content").addClass("skew-bottom-right")
                }), $(".view.section-footer").each(function () {
                    var a = $(this), b = a.prevAll(".view").first().children(".content");
                ...
                c.each(function () {
                    var a, b, c, e, f = $(this), g = f.data();
                    void 0 !== g.ssOpacity ? (a = g.ssOpacity, b = g.ssOrig.xr, c = g.ssOrig.yr, e = g.ssOrig.or) : (a = 1, b = 1, c = 1, e = "center center");
                    var h = g.normalX + g.zoomXDelta * b, i = g.normalY + g.zoomYDelta * c + (void 0 !== g.parallaxY ? g.parallaxY : 0), j = g.normalScale * (void 0 !== g.ssScale ? g.ssScale : 1);
                ...
                function c(a, c, d, e) {
                    var f = b(a), g = d / c > f.w / f.h ? d / f.w : c / f.h, h = f.w * g, i = f.h * g, j = (h - f.w) / 2, k = (i - f.h) / 2, l = Math.round((d - h) / 2), m = Math.round((e - i) / 2), n = a.data();
                    n.normalScale = g, n.normalX = l, n.normalY = m, n.zoomXDelta = j, n.zoomYDelta = k
                }

                {
                    var e = $(window), f = e.height(), g = e.width(), h = ($("#top-nav:visible"), f - a.topNav.state2H);
                    $(".page-border.bottom:visible")
                }
                $(".full-size, .half-size, .one-third-size").each(function () {
                    var a = $(this), b = parseInt(a.css({"padding-top": ""}).css("padding-top").replace("px", "")), c = parseInt(a.css({"padding-bottom": ""}).css("padding-bottom").replace("px", "")), d = 0 === a.offset().top ? f : h, e = Math.ceil(d / 2), g = Math.ceil(d / 3), i = a.hasClass("full-size") ? d : a.hasClass("half-size") ? e : g;
                    a.css({
                        "padding-top": b + "px",
                        "padding-bottom": c + "px"
                    ...
                    if (i > j) {
                        var k = i - j - b - c;
                        0 > k && (k = 0);
                        var l = Math.round(k / 2), m = k - l, n = b + l, o = c + m;
                        a.css({"padding-top": n + "px", "padding-bottom": o + "px"})
                    }
                }), $(".stretch-height").each(function () {
                    var a = $(this), b = a.parent(), c = b.find(".stretch-height");
                    c.css("height", ""), a.outerWidth() < b.innerWidth() && c.css("height", b.innerHeight() + "px")
                }), $(".stretch-full-height").each(function () {
                    var a = $(this), b = a.parent(), c = b.find(".stretch-full-height");
                    if (c.css("height", ""), a.outerWidth() < b.innerWidth()) {
                        var d = b.innerHeight(), e = d > f ? d : f;
                        c.css("height", e + "px")
                    }
                }), p.each(function (b) {
                    var e = $(this), g = e.find(".content"), h = g.find(".skew.skew-top-right, .skew.skew-top-left"), i = g.find(".skew.skew-bottom-left, .skew.skew-bottom-right"), j = g.width() + "px";
                    i.css({"border-left-width": j}), h.css({"border-right-width": j});
                    var k = e.height(), l = e.width(), m = function () {
                        var c, e = -1 * k, g = 0, h = f - k, i = f, j = d.parallaxMargin(a, b, e), l = d.parallaxMargin(a, b, g), m = d.parallaxMargin(a, b, h), n = d.parallaxMargin(a, b, i), o = function (a, b) {
                            return b + (a > 0 ? 0 : a)
                        }, p = function (a, b) {
                            var c = a + k;
                            return -b - (f > c ? 0 : c - f)
                ...
                var c = $(b), d = c.data("border-colors");
    ...
    7: [function (a, b) {
        b.exports = function (b, c) {
            "use strict";
            var d = $(".view"), e = a("./app-share.js"), f = $("html").hasClass("poor-browser");
            this.scroll = function () {
                f || d.each(function (a) {
                    var d = $(this), f = b.calcPosition(d);
                    if (f.visible) {
    ...
    8: [function (a, b) {
        b.exports = new function () {
            ...
            }, this.names = {}, this.colors = 10, this.colorClasses = function () {
    ...
    9: [function (a, b) {
        b.exports = function (b) {
            "use strict";
            function c() {
                p.css({height: C.height() - parseInt(o.css("top").replace("px", "")) - 30 + "px"})
            }

            function d() {
                "custom" !== t.val() && ($('<option value="custom">Custom</option>').appendTo(t), t.val("custom"), $.cookie.json = !1, $.cookie("themeSelect", "custom", {path: B}), $.cookie.json = !0)
            }
            ...
            function i(a, b, c, e, f, g) {
                ...
                if (j.val(i), "color" === c)j.minicolors({
                    ...
                    show: function () {
                        var a = j.parent(), b = a.children(".minicolors-panel"), c = b.outerHeight(!0), d = b.outerWidth(!0), e = $(window), f = e.width(), g = e.height(), h = b.offset(), i = h.left - $(document).scrollLeft(), k = h.top - $(document).scrollTop();
                    ...
                    hide: function () {
                        j.parent().children(".minicolors-panel").css({position: "", left: "", top: ""})
                    },
                    theme: "bootstrap"
                }); else {
                    var l;
            ...
            function j() {
                ...
                if (Object.keys(v.names).length > 0)for (var a in v.names)$('<option value="' + a + '">' + v.names[a] + "</option>").appendTo(t); else t.remove(), $('<a class="btn" href="#">Reset</a>').appendTo(p.find(".themes")).click(function (a) {
                    a.preventDefault(), $.cookie.json = !1, $.cookie("themeSelect", "", {path: B}), $.cookie.json = !0, A.hide(), x.gate(function () {
                        location.reload()
                    })
                });
                $.cookie.json = !1;
                var b = $.cookie("themeSelect");
                if ($.cookie.json = !0, "custom" === b)d(); else if (b)t.val(b); else {
                    var c = $("#factory-theme");
                    if (c.length > 0 && "hidden" === c.css("visibility")) {
                        var e = v.options[c.html()].style;
                        t.val(e), $.cookie.json = !1, $.cookie("themeSelect", e, {path: B}), $.cookie.json = !0
                    }
                }
                t.change(function () {
                    $(".options .themes select option[value=custom]").remove();
                    var a = $(this).val();
                    $.cookie.json = !1, $.cookie("themeSelect", a, {path: B}), $.cookie.json = !0, A.hide(), x.gate(function () {
                        location.reload()
                    })
                }), o.css({left: -1 * r + "px"}), q.click(function (a) {
                    ...
                    new TWEEN.Tween({autoAlpha: 0, x: -450}).to({autoAlpha: 1, x: 0}, 400).onUpdate(function () {
                        ...
                        }), s.css(Modernizr.csstransforms3d && y.force3D ? {transform: "translate3d(" + this.x + "px, 0px, 0px)"} : {transform: "translate(" + this.x + "px, 0px)"})
            ...
            function k(a) {
                ...
                $.cookie("lessVars", A.lessVars, {path: B}), l(b, function (b) {
                    if (!a) {
            ...
            var n, o, p, q, r, s, t, u, v = a("../app/themes.js"), w = a("../tools/tools.js"), x = a("../widgets/loading.js"), y = a("../app/app-share.js"), z = v.colors, A = this, B = "", C = $(window), D = !1;
            this.lessVars = {}, this.isShowPanel = function () {
                var a = w.getUrlParameter("customize");
                return void 0 === a ? a = $.cookie("customize") : $.cookie("customize", "yes", {path: B}), a && $("#top-nav").length > 0 ? !0 : !1
            }(), this.show = function () {
                setTimeout(function () {
                    if (!D) {
                        D = !0, k(!0), e();
                ...
                }, 550), o.css({left: "0px"}), o.addClass("on")
            }, this.hide = function () {
                o.css({left: -1 * r + "px"}), o.removeClass("on")
                ...
                "success" !== d && "notmodified" !== d ? ($("#customize-panel").remove(), b.afterConfigure()) : $.getScript("customize/custom-less.js", function (a, d) {
                    if ("success" !== d && "notmodified" !== d)$("#customize-panel").remove(), b.afterConfigure(); else {
                        o = $("#customize-panel"), p = o.find(".options"), q = o.find(".toggle-button"), r = p.width(), s = o.find(".custom-css"), t = p.find(".themes select"), u = p.find(".colors"), $.cookie.json = !0, j(), w.getUrlParameter("save-as-less") && $.cookie("saveAsLess", "yes", {path: B}), $.cookie.json = !1;
                        var f = $.cookie("themeSelect");
                        $.cookie.json = !0, "custom" === f && (D = !0, A.lessVars = $.cookie("lessVars"), k(), e(), p.find(".options-gate").css({visibility: "hidden"})), C.resize(c), c(), b.afterConfigure()
                    }
                })
            }) : b.afterConfigure()
        }
            ...
            !new function () {
                ...
                function widgets($context) {
                    if (new ShowList($context, me), new Sliders($context), isMobile || $context.find(".hover-dir").each(function () {
                        ...
                        }), isPoorBrowser)$context.find(".tlt-loop").remove(); else {
                        ...
                        loading.load(function () {
                            ...
                            $window.resize(function () {
                                ...
                                var b = function () {
                                    ...
                                    for (var a = $("img"), d = 0; d < a.length; d++)if (!a[d].width || !a[d].height)return void setTimeout(c, 100);
                                    b()
                                };
                                c()
                            })
    ...
    11: [function (a, b) {
        b.exports = new function () {
            "use strict";
            var b = this, c = (a("../script.js"), $("html").hasClass("android-browser-4_3minus"));
    ...
    14: [function (a, b) {
        b.exports = function (a, b) {
            ...
            c || a.find(".counter .count").each(function () {
                var a = $(this), c = parseInt(a.text()), d = {n: 0}, e = new TWEEN.Tween(d).to({n: c}, 1e3).onUpdate(function () {
                    a.text(Math.round(this.n))
                }).easing(TWEEN.Easing.Quartic.InOut), f = function () {
                    e.stop()
                }, g = function () {
                    d.n = 0, e.start()
                }, h = g;
    ...
    15: [function (a, b) {
        b.exports = new function () {
            "use strict";
            var a, b = $("html").hasClass("mobile"), c = $("body>section[id]");
            if (!b && c.length > 1) {
                var d = $("#dot-scroll");
                c.each(function () {
        ...
        b.exports = new function () {
            ...
            this.setup = function (a) {
                a.find(".fluid *").each(function () {
                    var a = $(this), b = a.parent(".fluid"), c = b.width(), d = a.attr("data-aspect-ratio");
    ...
    17: [function (require, module, exports) {
        module.exports = function (onBodyHeightResize, widgets, unwidgets) {
            "use strict";
            var tools = require("../tools/tools.js"), OverlayWindow = require("./overlay-window.js"), $topNav = $("#top-nav");
            $(".gallery").each(function (i) {
                ...
                var $gallery = $(this), $overlay = $($gallery.data("overlay")), overlayWindow = new OverlayWindow($overlay, widgets, unwidgets), $overlayNext = $overlay.find(".next"), $overlayPrevios = $overlay.find(".previos"), isFilter = !1, defaultGroup = $gallery.data("default-group") ? $gallery.data("default-group") : "all", isNonFirstLayout = !1;
                ...
                var $grid = $gallery.find(".grid").shuffle({
                    ...
                    isFilter && (isFilter = !1)
                }), $btns = $gallery.find(".filter a"), $itemView = $gallery.find(".item-view"), $itemShow = $itemView.find(".item-show"), $itemNext = $itemView.find(".next-item"), $itemPrev = $itemView.find(".prev-item"), $itemClose = $itemView.find(".close-item"), $all = $gallery.find(".filter a[data-group=all]"), $items = $grid.find(".item"), currentGroup = defaultGroup, $currentItem;
    ...
    18: [function (a, b) {
        b.exports = new function () {
            "use strict";
            var b = a("../tools/tools.js"), c = $(".gate"), d = c.find(".gate-bar"), e = c.find(".loader"), f = $("html").hasClass("android-browser-4_3minus"), g = this;
            this.queue = [], this.load = function (a) {
                var b = [];
                $("*:visible:not(script)").each(function () {
                    var a = $(this), c = a[0].nodeName.toLowerCase(), d = a.css("background-image"), e = a.attr("src"), f = a.data("loading");
                    if (f)b.push(f); else if ("img" === c && e && -1 === $.inArray(e, b))b.push(e); else if ("none" != d) {
                        var g = d.match(/url\(['"]?([^'")]*)/i);
                ...
                if (0 === b.length)a(); else {
                    ...
                    for (var h = 0, i = function () {
                        f++, h = f / b.length * 100, d.css({width: h + "%"}), f === b.length && (c.length < 1 ? a() : e.transitionEnd(function () {
                            e.removeClass("hided"), a()
                        }, 200).addClass("hided").removeClass("show"))
                    }, j = 0; j < b.length; j++)if ("function" == typeof b[j])b[j](i); else {
                        var k = new Image;
                        $(k).one("load", function () {
                            g.queue.push(i)
                        }), k.src = b[j]
                ...
                d.css({width: "0%"}), c.transitionEnd(function () {
                    a && a()
    ...
    19: [function (a, b) {
        b.exports = function (b) {
            ...
            "undefined" != typeof google && b.find(".map-open").each(function () {
                var a = $(this), b = $(a.data("map-overlay")), d = b.find(".map-canvas"), e = {
                ...
                d.find(".map-marker").each(function () {
                    var a = $(this);
                    f.push({latitude: a.data("latitude"), longitude: a.data("longitude"), text: a.data("text")})
                }), d.addClass("close-map").wrap('<div class="map-view"></div>');
                var g = d.parent(), h = new c(b, !1, !1, function () {
                    new TWEEN.Tween({autoAlpha: 1}).to({autoAlpha: 0}, 500).onUpdate(function () {
                        g.css({opacity: this.autoAlpha, visibility: this.autoAlpha > 0 ? "visible" : "hidden"})
                    }).easing(TWEEN.Easing.Linear.None).start()
                }), i = !1;
                a.click(function (a) {
                    a.preventDefault(), h.show(!1, function () {
                        ...
                        g.css({height: $(window).height() - l.height() + "px"}), new TWEEN.Tween({autoAlpha: 0}).to({autoAlpha: 1}, 500).onUpdate(function () {
                            g.css({opacity: this.autoAlpha, visibility: this.autoAlpha > 0 ? "visible" : "hidden"})
                        }).easing(TWEEN.Easing.Linear.None).start()
                    })
                })
        ...
        b.exports = function () {
            ...
            a.click(function (a) {
                ...
                if (b.hasClass("ext-nav-toggle")) {
                    var c = b.data("target"), d = $(c), e = $(c + ",#top-nav a:not(.menu-toggle),.page-border a"), f = function () {
    ...
    21: [function (a, b) {
        b.exports = function (a, b, c, d) {
            ...
            var f = a.find(".cross"), g = $(a.data("overlay-zoom")), h = a.find(".overlay-view"), f = a.find(".cross"), i = this;
            this.show = function (c, d) {
                var e = function () {
                    g.addClass("overlay-zoom"), a.transitionEnd(function () {
                        if (c) {
                            var e = a.find(".loader"), f = $('<div class="loaded-content"></div>');
    ...
    23: [function (a, b) {
        b.exports = function (a, b) {
            ...
            a.find(".skillbar").each(function () {
                var a = $(this), c = a.find(".skillbar-bar"), d = {width: 0}, e = parseInt(a.attr("data-percent").replace("%", "")), f = new TWEEN.Tween(d).to({width: e}, 1e3).onUpdate(function () {
                    c.css({width: this.width + "%"})
                }).easing(TWEEN.Easing.Quartic.Out), g = function () {
                    f.stop()
                }, h = function () {
                    d.width = 0, f.start()
                }, i = h;
    ...
    25: [function (a, b) {
        b.exports = function () {
            "use strict";
            var b = a("../tools/tools.js"), c = $("#top-nav"), d = !c.data("state1-colors") || !c.data("state2-colors"), e = $("body"), f = c.length > 0, g = c.find(".navbar-collapse"), h = 20, i = f ? 100 : 0, j = f ? 70 : 0, k = (a("../app/themes.js"), function () {
                return f ? h : 0
            }()), l = !1, m = !1, n = this, o = c.data("state1-colors"), p = c.data("state2-colors");
            this.state1H = i, this.state2H = j, this.state1Top = function () {
                return k
            }, this.state1 = function () {
                d ? this.state2() : f && !l && (e.removeClass("state2").addClass("state1"), c.removeClass(p).addClass(o), l = !0, m = !1, b.androidStylesFix(c))
            }, this.state2 = function () {
                f && !m && (e.removeClass("state1").addClass("state2"), d || c.removeClass(o), c.addClass(p), l = !1, m = !0, b.androidStylesFix(c))
            }, this.$menu = function () {
                return g
    ...
    26: [function (a, b) {
        b.exports = function () {
            "use strict";
            var a = $(".video-bg"), b = function () {
                var a = $("html").hasClass("mobile"), b = document.createElement("video"), c = b.canPlayType ? b.canPlayType("video/mp4") : !1;
                return c && !a
            }();
            return b ? void a.each(function () {
                ...
                a.data("loading", function (b) {
                    ...
                    var e = function () {
                        var a = c.width(), d = c.height(), e = a / d, f = $(window), g = function () {
                            var a, b, d = f.width(), g = f.height(), h = d / g;
    ...
    27: [function (a, b) {
        b.exports = function () {
            ...
            var b = [];
            a.each(function (a) {
                var c = $(this), d = c.attr("id");
                d || (d = "vimeo-bg-" + a, c.attr("id", d)), c.data("loading", function (a) {
                    b[d] = a
                })
            }), $.getScript("https://f.vimeocdn.com/js/froogaloop2.min.js").done(function () {
                a.each(function () {
                    var a = $(this), c = a.attr("id"), d = function () {
                        var b = a.data("volume");
                        return void 0 === b ? 0 : b
                    }(), e = a.data("video"), f = $('<iframe class="vimeo-bg" src="https://player.vimeo.com/video/' + e + "?api=1&badge=0&byline=0&portrait=0&title=0&autopause=0&player_id=" + c + '&amp;loop=1" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');
                    a.after(f), a.remove(), f.attr("id", c);
                    var g = $f(f[0]);
                    g.addEvent("ready", function () {
                        var a = function (a) {
                            var b = $(window).width(), c = $(window).height(), d = f.width(), e = f.height(), g = d / e, h = b / c, i = function (d, e) {
                                var h, i;
        ...
        module.exports = function () {
            ...
            firstScriptTag.parentNode.insertBefore(tag, firstScriptTag), window.onYouTubeIframeAPIReady = function () {
                $youtubeBgs.each(function () {
                    var $youtubeBg = $(this), videoId = $youtubeBg.data("video"), vol = $youtubeBg.data("volume"), mute = $youtubeBg.data("mute"), elId = $youtubeBg.attr("id"), isNotDone = !0, player = new YT.Player(elId, {
                        videoId: videoId,
                        playerVars: {
                            html5: 1,
                            controls: 0,
                        ...
                        events: {
                            onReady: function (event) {
                                var resize = function () {
                                    var $iFrame = $(event.target.getIframe()), windowW = $(window).width(), windowH = $(window).height(), iFrameW = $iFrame.width(), iFrameH = $iFrame.height(), ifRatio = iFrameW / iFrameH, wRatio = windowW / windowH, vRatio = function () {
