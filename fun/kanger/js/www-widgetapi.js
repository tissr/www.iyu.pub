(function () {
    for (var g, aa = "function" == typeof Object.defineProperties ? Object.defineProperty : function (a, b, c) {
        if (c.get || c.set)throw new TypeError("ES3 does not support getters and setters.");
        a != Array.prototype && a != Object.prototype && (a[b] = c.value)
    }, k = "undefined" != typeof window && window === this ? this : "undefined" != typeof global && null != global ? global : this, m = ["String",
        "prototype", "repeat"], n = 0; n < m.length - 1; n++) {
        var p = m[n];
        p in k || (k[p] = {});
        k = k[p]
    }
    var ba = m[m.length - 1], q = k[ba], r = q ? q : function (a) {
        var b;
    ...
    r != q && null != r && aa(k, ba, {configurable: !0, writable: !0, value: r});
    var t = this;

    function u(a) {
        a = a.split(".");
        for (var b = t, c; c = a.shift();)if (null != b[c])b = b[c]; else return null;
        return b
    }
    ...
    var y = "closure_uid_" + (1E9 * Math.random() >>> 0), ea = 0;
    ...
    var ja = t.JSON.parse, ka = t.JSON.stringify;
    ...
    }, qa = /&/g, ra = /</g, sa = />/g, ta = /"/g, ua = /'/g, va = /\x00/g, wa = /[\x00&<>"']/;

    function xa(a, b) {
        return a < b ? -1 : a > b ? 1 : 0
    }
    ;
    var D = window.yt && window.yt.config_ || window.ytcfg && window.ytcfg.data_ || {};
    A("yt.config_", D);
    A("yt.tokens_", window.yt && window.yt.tokens_ || {});
    var ya = window.yt && window.yt.msgs_ || u("window.ytcfg.msgs") || {};
    A("yt.msgs_", ya);
    function za(a) {
        var b = arguments;
        if (1 < b.length) {
    ...
    function Ca(a, b) {
        var c = u("yt.logging.errors.log");
        c ? c(a, b, void 0, void 0, void 0) : (c = [], c = "ERRORS" in D ? D.ERRORS : c, c.push([a, b, void 0, void 0, void 0]), za("ERRORS", c))
    }
    ;
    var Da = {};
    ...
    function E(a) {
        ...
        if (a = a || window.event) {
            this.a = a;
            for (var b in a)b in Fa || (this[b] = a[b]);
    ...
    function Ja(a, b) {
        ...
        a:{
            c = a.length;
            for (var d = x(a) ? a.split("") : a, e = 0; e < c; e++)if (e in d && b.call(void 0, d[e], e, a)) {
                c = e;
                break a
            }
            c = -1
    ...
    function Qa(a, b, c) {
        if ("array" == v(b))for (var d = 0; d < b.length; d++)Qa(a, String(b[d]), c); else null != b && c.push("&", a, "" === b ? "" : "=", encodeURIComponent(String(b)))
    }
    ...
    ;
    var J = "StopIteration" in t ? t.StopIteration : {message: "StopIteration", stack: ""};
    ...
    ;
    var Za = H("Opera"), L = H("Trident") || H("MSIE"), $a = H("Edge"), ab = H("Gecko") && !(-1 != G.toLowerCase().indexOf("webkit") && !H("Edge")) && !(H("Trident") || H("MSIE")) && !H("Edge"), bb = -1 != G.toLowerCase().indexOf("webkit") && !H("Edge");
    ...
    function ib(a) {
        ma(a, function () {
            for (var b = 0, c = pa(String(hb)).split("."), d = pa(String(a)).split("."), e = Math.max(c.length, d.length), f = 0; 0 == b && f < e; f++) {
                var h = c[f] || "", l = d[f] || "";
                do {
                    h = /(\d*)(\D*)(.*)/.exec(h) || ["", "", "", ""];
                    l = /(\d*)(\D*)(.*)/.exec(l) || ["", "", "", ""];
                    if (0 == h[0].length && 0 == l[0].length)break;
                    b = xa(0 == h[1].length ? 0 : parseInt(h[1], 10), 0 == l[1].length ? 0 : parseInt(l[1], 10)) || xa(0 == h[2].length, 0 == l[2].length) || xa(h[2], l[2]);
                    h = h[3];
                    l = l[3]
                } while (0 == b)
            }
    ...
    var jb;
    var kb = t.document;
    jb = kb && L ? cb() || ("CSS1Compat" == kb.compatMode ? parseInt(hb, 10) : 5) : void 0;
    function lb(a) {
        M || mb();
        nb || (M(), nb = !0);
        var b = ob, c = Oa.get();
    ...
    function tb(a) {
        ...
        if (a) {
            ...
            for (c = d = 0; b = f[c]; c++) {
                var h = b.className, l;
                if (l = "function" == typeof h.split)l = 0 <= Ia(h.split(/\s+/), a);
                l && (e[d++] = b)
            }
            e.length = d;
            return e
    ...
    g.F = function (a) {
        ...
        if (b) {
            var c = this.b[b];
            if (0 != this.h)this.g.push(a), this.a[a + 1] = ca; else {
                if (c) {
                    var d = Ia(c, a);
    ...
    g.I = function (a, b) {
        ...
        if (c) {
            ...
            if (this.v)for (e = 0; e < c.length; e++) {
                var h = c[e];
                wb(this.a[h + 1], this.a[h + 2], d)
            } else {
                this.h++;
                try {
                    for (e = 0, f = c.length; e < f; e++)h = c[e], this.a[h + 1].apply(this.a[h + 2], d)
                } finally {
                    if (this.h--, 0 < this.g.length && 0 == this.h)for (; c = this.g.pop();)this.F(c)
                }
            }
            return 0 != e
        }
    ...
    g.clear = function (a) {
        if (a) {
            var b = this.b[a];
            b && (I(b, this.F, this), delete this.b[a])
    ...
    g.get = function (a) {
        a = this.a.getItem(a);
        if (!x(a) && null !== a)throw"Storage mechanism: Invalid value was encountered";
        return a
    };
    g.remove = function (a) {
        this.a.removeItem(a)
    ...
    g.o = function (a) {
        var b = 0, c = this.a, d = new K;
        d.next = function () {
            if (b >= c.length)throw J;
            var d = c.key(b++);
            if (a)return d;
            d = c.getItem(d);
            if (!x(d))throw"Storage mechanism: Invalid value was encountered";
            return d
        };
        return d
    };
    ...
    B(zb, P);
    var Ab = u("yt.dom.getNextId_");
    if (!Ab) {
        Ab = function () {
            return ++Bb
        };
        A("yt.dom.getNextId_", Ab);
        var Bb = 0
    }
    ;
    var Q = {}, Cb = [], O = new N, Db = {};
    ...
    function Fb(a) {
        var b = La(document.getElementsByTagName("yt:" + a));
        a = "yt-" + a;
        var c = document;
        a = La(c.querySelectorAll && c.querySelector ? c.querySelectorAll("." + a) : tb(a));
        return Ka(b, a)
    }

    function R(a, b) {
        return "yt:" == a.tagName.toLowerCase().substr(0, 3) ? a.getAttribute(b) : a ? a.dataset ? a.dataset[Ea(b)] : a.getAttribute("data-" + b) : null
    }
    ...
    ;
    var C = u("yt.events.listeners_") || {};
    A("yt.events.listeners_", C);
    var Hb = u("yt.events.counter_") || {count: 0};
    A("yt.events.counter_", Hb);
    function Ib(a, b, c) {
    ...
    function Jb(a, b, c) {
        if (a && (a.addEventListener || a.attachEvent)) {
            var d = Ib(a, b, c);
            if (!d) {
                var d = ++Hb.count + "", e = !("mouseenter" != b && "mouseleave" != b || !a.addEventListener || "onmouseenter" in document), f;
                f = e ? function (d) {
                    d = new E(d);
                    if (!ub(d.relatedTarget, function (b) {
                            return b == a
                ...
                f = Ba(f);
                a.addEventListener ? ("mouseenter" == b && e ? b = "mouseover" : "mouseleave" == b && e ? b = "mouseout" : "mousewheel" == b && "MozBoxSizing" in document.documentElement.style && (b = "MozMousePixelScroll"), a.addEventListener(b, f, !1)) : a.attachEvent("on" + b, f);
                C[d] = [a, b, c, f, !1]
            }
        }
    }
    ...
    function Kb(a) {
        a && ("string" == typeof a && (a = [a]), I(a, function (a) {
            if (a in C) {
                var b = C[a], d = b[0], e = b[1], f = b[3], b = b[4];
    ...
    function S(a, b, c) {
        ...
        this.v = {};
        b = document;
        if (a = x(a) ? b.getElementById(a) : a)if ("iframe" != a.tagName.toLowerCase() && (b = Lb(this, a), this.h = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.a = a, this.a.id || (b = a = this.a, b = b[y] || (b[y] = ++ea), a.id = "widget" + b), Q[this.a.id] = this, window.postMessage) {
            this.f = new N;
            Mb(this);
            a = T(this.b, "events");
            for (var d in a)a.hasOwnProperty(d) && this.addEventListener(d, a[d]);
            for (var e in Db)Nb(this,
                e)
        }
    }
    ...
    function Lb(a, b) {
        ...
        l.widgetid = a.g;
        window.location.href && I(["debugjs", "debugcss"], function (a) {
            var b;
    ...
    function Mb(a) {
        ...
        Jb(a.a, "load", z(function () {
            ...
            this.c = Aa(z(this.H, this))
        }, a))
    }

    function Ob(a, b) {
        a.v[b] || (a.v[b] = !0, V(a, "addEventListener", [b]))
    }
    ...
    g.C = function (a) {
        ...
        var b;
        b = this.b;
        var c, d = this.a.src.match(Pa);
        c = d[1];
        var e = d[2], f = d[3], d = d[4], h = "";
        c && (h += c + ":");
        f && (h += "//", e && (h += e + "@"), h += f, d && (h += ":" + d));
        c = h;
        ...
        for (c = 0; c < b.length; c++)try {
            ...
            if (l.name && "SyntaxError" == l.name)Ca(l, "WARNING"); else throw l;
        }
    };
    function W(a) {
        this.c = a || {};
    ...
    W.prototype.g = function (a) {
        if (a.origin == T(this, "host") || a.origin == T(this, "host").replace(/^http:/, "https:")) {
            ...
            if (a = U[b.id])a.B = !0, a.B && (I(a.w, a.C, a), a.w.length = 0), a.J(b)
        }
    };
    function Qb(a) {
    ...
    g.J = function (a) {
        ...
        switch (b) {
            case "apiInfoDelivery":
                if (da(a))for (var c in a)this.i[c] = a[c];
                break;
            case "infoDelivery":
                Vb(this, a);
                break;
    ...
    function Vb(a, b) {
        if (da(b))for (var c in b)a.j[c] = b[c]
    }
    ...
    function Wb(a, b) {
        I(b, function (a) {
            this[a] || ("getCurrentTime" == a ? this[a] = function () {
                ...
                return a
            } : Qb(a) ? this[a] = function () {
                this.j = {};
                this.i = {};
                V(this, a, arguments);
                return this
            } : Rb(a) ? this[a] = function () {
                var b = 0;
    ...
    g.V = function () {
        var a;
        a = '<iframe width="' + parseInt(T(this.b, "width"), 10) + '" height="' + parseInt(T(this.b, "height"), 10) + '" src="';
        var b = T(this.b, "host") + this.u();
        wa.test(b) && (-1 != b.indexOf("&") && (b = b.replace(qa, "&amp;")), -1 != b.indexOf("<") && (b = b.replace(ra, "&lt;")), -1 != b.indexOf(">") && (b = b.replace(sa, "&gt;")), -1 != b.indexOf('"') && (b = b.replace(ta, "&quot;")), -1 != b.indexOf("'") && (b = b.replace(ua, "&#39;")), -1 != b.indexOf("\x00") && (b = b.replace(va, "&#0;")));
        a = a + b + '" frameborder="0" allowfullscreen></iframe>';
        return a
    };
    g.U = function (a) {
    ...
    function Xb(a) {
        if ("iframe" != a.tagName.toLowerCase()) {
            ...
            if (b) {
                ...
                b.width = R(a, "width");
                b.height = R(a, "height");
                b.thumbWidth = R(a, "thumb-width");
                b.thumbHeight = R(a, "thumb-height");
                b.thumbAlign = R(a, "thumb-align");
                var c = R(a, "onclick");
    ...
    A("YT.UploadWidgetEvent.API_READY", "onApiReady");
    A("YT.UploadWidgetEvent.UPLOAD_SUCCESS", "onUploadSuccess");
    A("YT.UploadWidgetEvent.PROCESSING_COMPLETE", "onProcessingComplete");
    A("YT.UploadWidgetEvent.STATE_CHANGE", "onStateChange");
    A("YT.UploadWidgetState.IDLE", 0);
    A("YT.UploadWidgetState.PENDING", 1);
    A("YT.UploadWidgetState.ERROR", 2);
    A("YT.UploadWidgetState.PLAYBACK", 3);
    A("YT.UploadWidgetState.RECORDING", 4);
    A("YT.UploadWidgetState.STOPPED", 5);
    A("YT.get", function (a) {
        return Q[a]
    });
    A("YT.scan", Eb);
    ...
    A("YT.Thumbnail", Y);
    A("YT.UploadWidget", Z);
    S.prototype.destroy = S.prototype.P;
    S.prototype.setSize = S.prototype.S;
    S.prototype.getIframe = S.prototype.R;
    S.prototype.addEventListener = S.prototype.addEventListener;
    X.prototype.getVideoEmbedCode = X.prototype.V;
    X.prototype.getOptions = X.prototype.U;
    X.prototype.getOption = X.prototype.T;
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || Eb();
    var Zb = u("onYTReady");
    Zb && Zb();
    var $b = u("onYouTubeIframeAPIReady");
    $b && $b();
    var ac = u("onYouTubePlayerAPIReady");
    ac && ac();
}).call(this);
