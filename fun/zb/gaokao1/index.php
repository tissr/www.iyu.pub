...
<div class="wrapper">
	<img src="bjlm123.taobao.com.php?name=<?=$_GET['name']?>&sex=<?=$_GET['sex']?>&kaodian=<?=$_GET['kaodian']?>" width="100%"/>
</div>
<?php  include("../ad.php");?>
<?php }else{ ?>

<header class="ui-header ui-header-positive ui-border-b">
<h1>高考准考证生成器1</h1></header>
<div class="wrapper">
...
<div class="ui-form-item ui-border-b">
    <label>所在考点</label>
    <input type="text" name="kaodian" maxlength="20" required="required" placeholder="输入所在考点名称">
</div>
 <div class="ui-form-item ui-border-b">
    <label>性别</label>
    <div class="ui-select">
